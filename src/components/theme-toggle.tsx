...
// Inline, render-blocking script that sets `data-theme` on <html> BEFORE the page
// paints — so the saved/OS theme is applied with zero flash of the wrong palette.
// Kept tiny and dependency-free; it mirrors currentTheme()'s resolution order.
