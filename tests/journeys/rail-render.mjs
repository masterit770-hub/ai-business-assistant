...
//
//   RENDER_BASE  override target (default: the LIVE production deployment)
import { chromium } from "playwright-core";
import fs from "node:fs";

// Default = the LIVE production deployment, pinned to PRODUCTION_FRONTEND_URL
// (src/lib/backend-redirect.ts) by tests/unit/prod-url-pin.test.mts.
const BASE = process.env.RENDER_BASE || "https://nucleus-770.vercel.app";
